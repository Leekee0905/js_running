...
// 5의 배수를 찾아 반환해주세요
// 결과값 [10]을 출력해주세요
console.log(arr.filter((e) => e % 5 === 0));

//3
const numbers = [5, 10, 15, 20, 25];
// 크기가 15보다 큰 숫자의 값을 반환하여 출력해주세요
// 출력값 [20, 25]
console.log(numbers.filter((e) => e > 15));
...
console.log(arr.filter((e) => e.length >= 4));
...
console.log(arr.filter((e) => e.length % 2 === 1));
...
console.log(student.find((e) => e.name === null));
//9
var arr = [
  "banana",
  "kiwi",
